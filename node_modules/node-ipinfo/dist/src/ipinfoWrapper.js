...
var IPinfoWrapper = (function () {
    ...
    IPinfoWrapper.prototype.lookupResproxy = function (ip) {
        return __awaiter(this, void 0, void 0, function () {
            var cacheKey, data;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        cacheKey = "resproxy:".concat(ip);
                        return [4, this.cache.get(IPinfoWrapper.cacheKey(cacheKey))];
                    case 1:
                        data = _a.sent();
                        if (data) {
                            return [2, data];
                        }
                        return [2, this.fetchApi("resproxy/".concat(ip)).then(function (response) { return __awaiter(_this, void 0, void 0, function () {
                                var resproxy;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4, response.json()];
